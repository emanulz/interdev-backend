    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consecutive', models.AutoField(editable=False, primary_key=True, serialize=False, verbose_name='Consecutivo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=255, null=True, verbose_name='Descripción del movimiento')),
                ('created', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Fecha de creación')),
                ('updated', models.DateTimeField(auto_now=True, null=True, verbose_name='Fecha de modificación')),
            ],
            options={
